...
def register1(request):
    ...
    return render(request, "album/register1.html")
...
def user(request, user_id=None):
    ...
    return render(request, "album/user.html", context)
...
def followers(request, user_id):
    ...
    return render(request, "album/followers.html", context)
...
def following(request, user_id):
    ...
    return render(request, "album/following.html", context)
...
def post(request, post_id):
    ...
    return render(request, "album/post.html", context)
